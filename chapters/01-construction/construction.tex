...
Consequently, RDF knowledge graph construction is not merely a data engineering task — it is a semantic artefact design process,
...
In~\cref{sec:preliminaries}, the foundations of RDF knowledge graph constructions are introduced. This section also
explains the virtualization and materialization approaches to data integration.
...
However, the map-reduce paradigmn does not work well for generic SPARQL query workloads.
